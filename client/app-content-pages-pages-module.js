...
/***/ "./src/app/content/pages/auth.guard.ts":
/*!*********************************************!*\
  !*** ./src/app/content/pages/auth.guard.ts ***!
  \*********************************************/
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function () {
        if (localStorage.getItem('token') && localStorage.getItem('identity')) {
            if (JSON.parse(localStorage.getItem('identity')).rol == 1 || JSON.parse(localStorage.getItem('identity')).rol == 2) {
                return true;
            }
            else {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _components_e_commerce_core_models_usuario_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/e-commerce/_core/models/usuario.model */ "./src/app/content/pages/components/e-commerce/_core/models/usuario.model.ts");
/* harmony import */ var _components_e_commerce_core_services_usuario_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/e-commerce/_core/services/usuario.service */ "./src/app/content/pages/components/e-commerce/_core/services/usuario.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(_usuarioService, fb) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.createForm();
        this._usuarioService.findUsuarioByCedula(this.identity.cedula).subscribe(function (res) {
            _this.usuario = res;
            _this.llenarCampos();
        }, function (error) {
            console.log(error);
    ...
    ProfileComponent.prototype.getIdentity = function () {
    ...
    ProfileComponent.prototype.llenarCampos = function () {
        // console.log(this.usuario);
    ...
    ProfileComponent.prototype.createForm = function () {
        this.usuarioForm = this.fb.group({
            nombres: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(255), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(3)])],
            apellidos: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(255), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(3)])],
            cedula: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(10), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern("^[0-9]*$"),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(10)])],
            clave: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(50)])],
            // rol: [this.usuario.rol, Validators.required],
            direccion: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(255)])],
            referencia: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(255)])],
            ciudad: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(255)])],
            telefono: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(10),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(7), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern("^[0-9]*$")])],
            correo: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(50)]]
        });
    };
    // createForm() {
    // 	this.usuarioForm = this.fb.group({
    ...
    // 	});
    // }
    ProfileComponent.prototype.prepareCustomer = function () {
        var controls = this.usuarioForm.controls;
        var _usuario = new _components_e_commerce_core_models_usuario_model__WEBPACK_IMPORTED_MODULE_1__["UsuarioModel"]();
    ...
    ProfileComponent.prototype.onSubmit = function () {
        ...
        var user = this.prepareCustomer();
        this._usuarioService.crudUsuario(user, 2).subscribe(function (res) {
    ...
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_components_e_commerce_core_services_usuario_service__WEBPACK_IMPORTED_MODULE_2__["UsuarioService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])
    ], ProfileComponent);
...
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./auth.guard */ "./src/app/content/pages/auth.guard.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var _egreso_print_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./egreso/print.service */ "./src/app/content/pages/egreso/print.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagesComponent = /** @class */ (function () {
    function PagesComponent(el, configService, classInitService, router, layoutRefService, animationBuilder, translationService, printService) {
        var _this = this;
        this.el = el;
    ...
    PagesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"],
            ...
            _egreso_print_service__WEBPACK_IMPORTED_MODULE_9__["PrintService"]])
    ], PagesComponent);
...
/* harmony import */ var _partials_partials_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../partials/partials.module */ "./src/app/content/partials/partials.module.ts");
...
/* harmony import */ var _components_e_commerce_core_utils_http_utils_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/e-commerce/_core/utils/http-utils.service */ "./src/app/content/pages/components/e-commerce/_core/utils/http-utils.service.ts");
/* harmony import */ var _components_e_commerce_core_services_usuario_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/e-commerce/_core/services/usuario.service */ "./src/app/content/pages/components/e-commerce/_core/services/usuario.service.ts");
/* harmony import */ var _header_profile_profile_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./header/profile/profile.component */ "./src/app/content/pages/header/profile/profile.component.ts");
/* harmony import */ var _partials_content_general_portlet_portlet_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../partials/content/general/portlet/portlet.module */ "./src/app/content/partials/content/general/portlet/portlet.module.ts");
    ...
    PagesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _header_profile_profile_component__WEBPACK_IMPORTED_MODULE_14__["ProfileComponent"],
            ...
            providers: [_components_e_commerce_core_utils_http_utils_service__WEBPACK_IMPORTED_MODULE_12__["HttpUtilsService"], _components_e_commerce_core_services_usuario_service__WEBPACK_IMPORTED_MODULE_13__["UsuarioService"]]
        })
    ], PagesModule);
    return PagesModule;
}());

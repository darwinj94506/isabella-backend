...
/* harmony import */ var _respuesta_mec_respuesta_mec_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./respuesta-mec/respuesta-mec.component */ "./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AuthModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _respuesta_mec_respuesta_mec_component__WEBPACK_IMPORTED_MODULE_12__["RespuestaMecComponent"]
            ]
        })
    ], AuthModule);
    return AuthModule;
...
module.exports = "<!--begin::Signin-->\r\n<div class=\"m-login__signin\">\r\n    <div class=\"m-login__title\">\r\n        <h3>Inicio de sesión</h3>\r\n    </div>\r\n\r\n    <m-auth-notice></m-auth-notice>\r\n\r\n    <!--begin::Form-->\r\n    <form class=\"m-login__form m-form\" name=\"form\" (ngSubmit)=\"f.form.valid && submit()\" #f=\"ngForm\" novalidate>\r\n        <div class=\"form-group\">\r\n            <mat-form-field>\r\n                <mat-label>Cédula</mat-label>\r\n                <input matInput type=\"text\" name=\"cedula\" placeholder=\"Cédula\" autocomplete=\"off\" [(ngModel)]=\"model.cedula\" #cedula=\"ngModel\" required>\r\n            </mat-form-field>\r\n        </div>\r\n        <div class=\"form-group\">\r\n            <mat-form-field>\r\n                <mat-label>Contraseña</mat-label>\r\n                <input matInput type=\"password\" name=\"password\" placeholder=\"Password\" autocomplete=\"off\" [(ngModel)]=\"model.password\" #password=\"ngModel\" required>\r\n            </mat-form-field>\r\n        </div>\r\n    </form>\r\n    <!--end::Form-->\r\n\r\n    <!--begin::Action-->\r\n\r\n    <div class=\"m-login__action m-login__action--fit\">\r\n        <a href=\"javascript:;\" class=\"m-link\">\r\n            <span>Solicite una cuenta al administrador</span>\r\n        </a>\r\n        <m-spinner-button [options]=\"spinner\" (click)=\"submit()\">Ingresar</m-spinner-button>\r\n    </div>\r\n\r\n    <!--end::Action-->\r\n\r\n    <!--begin::Divider-->\r\n\r\n    <div class=\"m-login__form-divider\">\r\n        <div class=\"m-divider\">\r\n            <span></span>\r\n            <span translate=\"AUTH.GENERAL.OR\">OR</span>\r\n            <span></span>\r\n        </div>\r\n    </div>\r\n\r\n    <!--end::Divider-->\r\n\r\n    <!--begin::Options-->\r\n    <div class=\"m-login__options\">\r\n        <a href=\"javascript:;\" mat-raised-button color=\"primary\">\r\n            <span>\r\n\t\t\t\t<i class=\"fab fa-facebook-f\"></i>&nbsp;\r\n\t\t\t\t<span>Facebook</span>\r\n            </span>\r\n        </a>\r\n\r\n        <a href=\"javascript:;\" mat-raised-button color=\"accent\">\r\n            <span>\r\n\t\t\t\t<i class=\"fab fa-twitter\"></i>&nbsp;\r\n\t\t\t\t<span>Twitter</span>\r\n            </span>\r\n        </a>\r\n\r\n        <a href=\"javascript:;\" mat-raised-button color=\"warn\">\r\n            <span>\r\n\t\t\t\t<i class=\"fab fa-google\"></i>&nbsp;\r\n\t\t\t\t<span>Google</span>\r\n            </span>\r\n        </a>\r\n    </div>\r\n\r\n    <!--end::Options-->\r\n</div>\r\n<!--end::Signin-->"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.submit = function () {
        ...
        this.spinner.active = true;
        if (this.validate(this.f)) {
            this.authService.signup(this.model).subscribe(function (response) {
    ...
    LoginComponent.prototype.validate = function (f) {
        ...
        this.errors = [];
        // if (objectPath.get(f, 'form.controls.cedula.errors.cedula')) {
        // 	this.errors.push(this.translate.instant('AUTH.VALIDATION.INVALID', {name: this.translate.instant('AUTH.INPUT.EMAIL')}));
        // }
        if (object_path__WEBPACK_IMPORTED_MODULE_6__["get"](f, 'form.controls.cedula.errors.required')) {
            this.errors.push(this.translate.instant('AUTH.VALIDATION.REQUIRED', "CEDULA"));
        }
...
/***/ "./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.html":
/*!*******************************************************************************!*\
  !*** ./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.html ***!
  \*******************************************************************************/
/*! no static exports found */
...
module.exports = "<div>\n  <button routerLink=\"/\">Continuar\n  </button>\n</div>"

/***/ }),

/***/ "./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.scss":
/*!*******************************************************************************!*\
  !*** ./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.scss ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.ts ***!
  \*****************************************************************************/
/*! exports provided: RespuestaMecComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RespuestaMecComponent", function() { return RespuestaMecComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../core/auth/authentication.service */ "./src/app/core/auth/authentication.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var RespuestaMecComponent = /** @class */ (function () {
    function RespuestaMecComponent(authService) {
        this.authService = authService;
    }
    RespuestaMecComponent.prototype.ngOnInit = function () {
    };
    RespuestaMecComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'm-respuesta-mec',
            template: __webpack_require__(/*! ./respuesta-mec.component.html */ "./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.html"),
            styles: [__webpack_require__(/*! ./respuesta-mec.component.scss */ "./src/app/content/pages/auth/respuesta-mec/respuesta-mec.component.scss")]
        }),
        __metadata("design:paramtypes", [_core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]])
    ], RespuestaMecComponent);
    return RespuestaMecComponent;
}());

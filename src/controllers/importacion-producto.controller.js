...
function crudImportacionProducto(req, res, next) {
    var SQL = 'select * from  fun_ime_importacion_producto($1, $2, $3,$4,$5,$6);';
    console.log([
